...
if (!function_exists('autoparts_trx_addons_theme_setup9')) {
	...
	function autoparts_trx_addons_theme_setup9() {
		if (autoparts_exists_trx_addons()) {
			...
			if (is_admin()) {
				add_filter( 'autoparts_filter_allow_meta_box', 			'autoparts_trx_addons_allow_meta_box', 10, 2);
...
if ( !function_exists( 'autoparts_trx_addons_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('autoparts_filter_tgmpa_required_plugins',	'autoparts_trx_addons_tgmpa_required_plugins');
...
if ( !function_exists( 'autoparts_trx_addons_detect_blog_mode' ) ) {
	//Handler of the add_filter( 'autoparts_filter_detect_blog_mode', 'autoparts_trx_addons_detect_blog_mode' );
...
if ( !function_exists( 'autoparts_trx_addons_list_post_types' ) ) {
	//Handler of the add_filter( 'autoparts_filter_list_posts_types', 'autoparts_trx_addons_list_post_types');
...
if ( !function_exists( 'autoparts_trx_addons_post_type_taxonomy' ) ) {
	//Handler of the add_filter( 'autoparts_filter_post_type_taxonomy',	'autoparts_trx_addons_post_type_taxonomy', 10, 2 );
...
if ( !function_exists( 'autoparts_trx_addons_get_post_categories' ) ) {
	//Handler of the add_filter( 'autoparts_filter_get_post_categories', 		'autoparts_trx_addons_get_post_categories');
...
if ( !function_exists( 'autoparts_trx_addons_get_post_date_wrap' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_get_post_date', 'autoparts_trx_addons_get_post_date_wrap');
...
if ( !function_exists( 'autoparts_trx_addons_get_post_date' ) ) {
	//Handler of the add_filter( 'autoparts_filter_get_post_date', 'autoparts_trx_addons_get_post_date');
...
if (!function_exists('autoparts_trx_addons_allow_meta_box')) {
	//Handler of the add_filter( 'autoparts_filter_allow_meta_box', 'autoparts_trx_addons_allow_meta_box', 10, 2);
	function autoparts_trx_addons_allow_meta_box($allow, $post_type) {
		return $allow
...
if (!function_exists('autoparts_trx_addons_allow_theme_icons')) {
	//Handler of the add_filter( 'autoparts_filter_allow_theme_icons', 'autoparts_trx_addons_allow_theme_icons', 10, 2);
...
if (!function_exists('autoparts_trx_addons_args_related')) {
	//Handler of the add_filter( 'trx_addons_filter_args_related', 'autoparts_trx_addons_args_related');
...
if ( !function_exists( 'autoparts_trx_addons_list_header_styles' ) ) {
	//Handler of the add_filter( 'autoparts_filter_list_header_styles', 'autoparts_trx_addons_list_header_styles');
...
if ( !function_exists( 'autoparts_trx_addons_list_footer_styles' ) ) {
	//Handler of the add_filter( 'autoparts_filter_list_footer_styles', 'autoparts_trx_addons_list_footer_styles');
...
if (!function_exists('autoparts_trx_addons_default_layouts')) {
	//Handler of the add_filter( 'trx_addons_filter_default_layouts',	'autoparts_trx_addons_default_layouts');
...
if (!function_exists('autoparts_trx_addons_default_components')) {
	//Handler of the add_filter( 'trx_addons_filter_load_options',	'autoparts_trx_addons_default_components');
...
if ( !function_exists( 'autoparts_trx_addons_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'autoparts_trx_addons_frontend_scripts', 1100 );
	function autoparts_trx_addons_frontend_scripts() {
		if (autoparts_exists_trx_addons()) {
			if (autoparts_is_on(autoparts_get_theme_option('debug_mode')) && autoparts_get_file_dir('plugins/trx_addons/trx_addons.css')!='') {
				wp_enqueue_style( 'autoparts-trx_addons',  autoparts_get_file_url('plugins/trx_addons/trx_addons.css'), array(), null );
				wp_enqueue_style( 'autoparts-trx_addons_editor',  autoparts_get_file_url('plugins/trx_addons/trx_addons.editor.css'), array(), null );
			}
			if (autoparts_is_on(autoparts_get_theme_option('debug_mode')) && autoparts_get_file_dir('plugins/trx_addons/trx_addons.js')!='')
				wp_enqueue_script( 'autoparts-trx_addons', autoparts_get_file_url('plugins/trx_addons/trx_addons.js'), array('jquery'), null, true );
		}
...
if ( !function_exists( 'autoparts_trx_addons_merge_styles' ) ) {
	//Handler of the add_filter( 'autoparts_filter_merge_styles', 'autoparts_trx_addons_merge_styles');
...
if ( !function_exists( 'autoparts_trx_addons_merge_scripts' ) ) {
	//Handler of the add_filter('autoparts_filter_merge_scripts', 'autoparts_trx_addons_merge_scripts');
...
if ( !function_exists( 'autoparts_trx_addons_editor_load_scripts_admin' ) ) {
	//Handler of the add_action("admin_enqueue_scripts", 'autoparts_trx_addons_editor_load_scripts_admin');
...
if ( !function_exists( 'autoparts_trx_addons_featured_image' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_featured_image', 'autoparts_trx_addons_featured_image', 10, 2);
...
if ( !function_exists( 'autoparts_trx_addons_no_image' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_no_image', 'autoparts_trx_addons_no_image');
...
if ( !function_exists( 'autoparts_trx_addons_get_list_icons' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_get_list_icons', 'autoparts_trx_addons_get_list_icons', 10, 2 );
...
if (!function_exists('autoparts_trx_addons_query_sort_order')) {
	//Handler of the add_filter('autoparts_filter_query_sort_order', 'autoparts_trx_addons_query_sort_order', 10, 3);
...
if ( !function_exists( 'autoparts_trx_addons_theme_logo' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_theme_logo', 'autoparts_trx_addons_theme_logo');
...
if ( !function_exists( 'autoparts_trx_addons_post_meta' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_post_meta',	'autoparts_trx_addons_post_meta', 10, 2);
...
if ( !function_exists( 'autoparts_trx_addons_get_mobile_menu' ) ) {
	//Handler of the add_filter("autoparts_filter_get_mobile_menu", 'autoparts_trx_addons_get_mobile_menu');
...
if (!function_exists('autoparts_trx_addons_action_login')) {
	//Handler of the add_action( 'autoparts_action_login',		'autoparts_trx_addons_action_login', 10, 2);
...
if (!function_exists('autoparts_trx_addons_action_search')) {
	//Handler of the add_action( 'autoparts_action_search', 'autoparts_trx_addons_action_search', 10, 3);
...
if (!function_exists('autoparts_trx_addons_action_breadcrumbs')) {
	//Handler of the add_action( 'autoparts_action_breadcrumbs',	'autoparts_trx_addons_action_breadcrumbs');
...
if (!function_exists('autoparts_trx_addons_action_show_layout')) {
	//Handler of the add_action( 'autoparts_action_show_layout', 'autoparts_trx_addons_action_show_layout', 10, 1);
...
if (!function_exists('autoparts_trx_addons_action_user_meta')) {
	//Handler of the add_action( 'autoparts_action_user_meta', 'autoparts_trx_addons_action_user_meta');
...
if ( !function_exists( 'autoparts_trx_addons_get_blog_title' ) ) {
	//Handler of the add_filter( 'autoparts_filter_get_blog_title', 'autoparts_trx_addons_get_blog_title');
...
if (!function_exists('autoparts_trx_addons_prepare_css')) {
	//Handler of the add_filter( 'autoparts_filter_prepare_css',	'autoparts_trx_addons_prepare_css', 10, 2);
...
if (!function_exists('autoparts_trx_addons_prepare_js')) {
	//Handler of the add_filter( 'autoparts_filter_prepare_js',	'autoparts_trx_addons_prepare_js', 10, 2);
...
if (!function_exists('autoparts_trx_addons_localize_script')) {
	//Handler of the add_filter( 'autoparts_filter_localize_script',	'autoparts_trx_addons_localize_script');
