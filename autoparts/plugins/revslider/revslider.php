...
if ( !function_exists( 'autoparts_revslider_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('autoparts_filter_tgmpa_required_plugins',	'autoparts_revslider_tgmpa_required_plugins');
...
if ( !function_exists( 'autoparts_revslider_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'autoparts_revslider_frontend_scripts', 1100 );
...
if ( !function_exists( 'autoparts_revslider_merge_styles' ) ) {
	//Handler of the add_filter('autoparts_filter_merge_styles', 'autoparts_revslider_merge_styles');
