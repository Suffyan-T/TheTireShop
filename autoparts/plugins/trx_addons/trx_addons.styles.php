...
if (!function_exists('autoparts_trx_addons_get_css')) {
	add_filter('autoparts_filter_get_css', 'autoparts_trx_addons_get_css', 10, 4);
	function autoparts_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_layouts_row_type_narrow .sc_layouts_item ul ul a,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item ul ul a {
	color: {$colors['extra_link2']};
}
.sc_layouts_row_type_narrow .sc_layouts_item ul ul a:hover,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item ul ul a:hover {
	color: {$colors['extra_hover2']} !important;
}

.header_position_over .top_panel .sc_layouts_row.sc_layouts_row_type_narrow.sc_layouts_row_fixed.sc_layouts_row_fixed_on,
.header_position_over .top_panel .scheme_self.sc_layouts_row.sc_layouts_row_type_narrow.sc_layouts_row_fixed.sc_layouts_row_fixed_on {
	color: {$colors['extra_text']};
	background-color: {$colors['alter_bg_color']};
}
...
.sc_layouts_row_type_narrow .sc_layouts_item a.sc_button:hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item a.sc_button:hover,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item a.sc_button:hover .sc_layouts_item_icon {
	color: {$colors['inverse_text']} !important;
}
.sc_layouts_row_type_narrow .sc_layouts_item ul ul a:hover,
.sc_layouts_row_type_narrow .sc_layouts_item ul ul a:hover .sc_layouts_item_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item ul ul a:hover,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item ul ul a:hover .sc_layouts_item_icon {
...
.scheme_self.sc_layouts_row_type_narrow .search_wrap .search_field {
	...
	background-color: {$colors['extra_text_008']} !important;
	border-color: {$colors['extra_text_015']} !important;
}
...
.sc_layouts_row_type_narrow .search_wrap.search_style_narrow .search_submit,
.scheme_self.sc_layouts_row_type_narrow .search_wrap.search_style_normal .search_submit {
	color: {$colors['extra_text']}; 
}
.sc_layouts_row_type_narrow .search_wrap.search_style_normal .search_submit:hover,
.scheme_self.sc_layouts_row_type_narrow .search_wrap.search_style_normal .search_submit:hover {
	color: {$colors['text_link3']};
}
...
.sc_layouts_row_type_narrow .sc_layouts_item_icon.sc_layouts_cart_icon,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_icon.sc_layouts_cart_icon,
.sc_layouts_row_type_narrow .sc_layouts_item_details .sc_layouts_cart_summa,
.scheme_self.sc_layouts_row_type_narrow .sc_layouts_item_details .sc_layouts_cart_summa  {
...
.scheme_self.sc_layouts_row.sc_layouts_row_type_compact {
	background-color: {$colors['alter_bg_color']};
}
...
.scheme_self.sc_layouts_row_type_compact .sc_layouts_item_icon.sc_layouts_cart_icon {
...
.scheme_self.sc_layouts_row.sc_layouts_row_type_normal {
	background-color: {$colors['alter_bg_color']};
}
...
.scheme_self.sc_layouts_row_type_normal .search_wrap .search_field {
	color: {$colors['extra_text']};
	background-color: {$colors['extra_text_008']};
	border-color: {$colors['extra_text_015']};
}
...
.scheme_self.sc_layouts_row_type_normal .socials_wrap .social_item .social_icon {
	background-color: transparent;
	color: {$colors['extra_text']};
}
.sc_layouts_row_type_normal .socials_wrap .social_item:hover .social_icon,
.scheme_self.sc_layouts_row_type_normal .socials_wrap .social_item:hover .social_icon {
	background-color: transparent;
	color: {$colors['text_link3']};
}

.sc_layouts_row_type_normal .sc_layouts_item_icon.sc_layouts_cart_icon,
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item_icon.sc_layouts_cart_icon,
.sc_layouts_row_type_normal .sc_layouts_item_details .sc_layouts_cart_summa,
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item_details .sc_layouts_cart_summa  {
	color: {$colors['text_link2']};
}
.sc_layouts_row_type_normal .sc_layouts_cart_details  .sc_layouts_item_icon.sc_layouts_cart_icon:hover,
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item_icon.sc_layouts_cart_icon:hover,
.sc_layouts_item_details .sc_layouts_cart_summa:hover,
.scheme_self.sc_layouts_row_type_normal .sc_layouts_item_details .sc_layouts_cart_summa:hover  {
	color: {$colors['extra_hover']} !important;
}
...
.scheme_self.sc_layouts_title .sc_layouts_title_caption{
...
.scheme_self.sc_layouts_title_breadcrumbs {
	color: {$colors['inverse_text_03']};
}
...
.scheme_self.default_header .sc_layouts_title .sc_layouts_title_caption{
	color: {$colors['alter_light']};
}
.sc_layouts_title .sc_layouts_title_description,
.default_header .sc_layouts_title .sc_layouts_title_description{
	color: {$colors['alter_light']};
}
.default_header .sc_layouts_title_breadcrumbs,
.scheme_self.default_header .sc_layouts_title_breadcrumbs {
	color: {$colors['inverse_text_03']};
}
.default_header .sc_layouts_title_breadcrumbs a {
	color: {$colors['inverse_text_03']};
}
...
.sc_layouts_menu_nav > li.current-menu-item:before,
.sc_layouts_menu_nav > li.current-menu-parent:before,
.sc_layouts_menu_nav > li.current-menu-ancestor:before,
...
.trx_addons_text_link3, a.trx_addons_text_link3{
	color: {$colors['text_link3']};
}
.trx_addons_text_link3:hover, a.trx_addons_text_link3:hover{
...
.trx_addons_hover_mask {
	background-color: {$colors['text_05']};
}
...
.sc_blogger .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet,
.sc_blogger .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet,
.sc_blogger .swiper-pagination-custom .swiper-pagination-button,
.sc_services .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet,
.sc_services .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet,
.sc_services .swiper-pagination-custom .swiper-pagination-button {
	border-color: {$colors['text_light']};
...
.sc_blogger .swiper-pagination-custom .swiper-pagination-button.swiper-pagination-button-active,
.sc_blogger .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.sc_blogger .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.sc_blogger .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet:hover,
.sc_blogger .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet:hover,
.sc_services .swiper-pagination-custom .swiper-pagination-button.swiper-pagination-button-active,
.sc_services .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.sc_services .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet.swiper-pagination-bullet-active,
.sc_services .slider_swiper .slider_pagination_wrap .swiper-pagination-bullet:hover,
.sc_services .slider_swiper_outer .slider_pagination_wrap .swiper-pagination-bullet:hover {
	background-color: {$colors['text_link']};
}
...
/* Title */
.scheme_self.sc_title h1,
.scheme_self.sc_title h2,
.scheme_self.sc_title h3,
.scheme_self.sc_title h4,
.scheme_self.sc_title h5,
.scheme_self.sc_title h6,
.scheme_self.sc_title h1[class*="sc_title_"] ,
.scheme_self.sc_title h1[class*="sc_title_"],
.scheme_self.sc_title h3[class*="sc_title_"],
.scheme_self.sc_title h4[class*="sc_title_"],
.scheme_self.sc_title h5[class*="sc_title_"],
.scheme_self.sc_title h6[class*="sc_title_"]{
	color: {$colors['extra_text']} ;
}

.color_style_link2.sc_title h1,
.color_style_link2.sc_title h2,
.color_style_link2.sc_title h3,
.color_style_link2.sc_title h4,
.color_style_link2.sc_title h5,
.color_style_link2.sc_title h6,
.color_style_link2.sc_title h1[class*="sc_title_"],
.color_style_link2.sc_title h1[class*="sc_title_"],
.color_style_link2.sc_title h3[class*="sc_title_"],
.color_style_link2.sc_title h4[class*="sc_title_"],
.color_style_link2.sc_title h5[class*="sc_title_"],
.color_style_link2.sc_title h6[class*="sc_title_"]{
	color: {$colors['text_link2']};
}

.color_style_link3.sc_title h1,
.color_style_link3.sc_title h2,
.color_style_link3.sc_title h3,
.color_style_link3.sc_title h4,
.color_style_link3.sc_title h5,
.color_style_link3.sc_title h6,
.color_style_link3.sc_title h1[class*="sc_title_"],
.color_style_link3.sc_title h1[class*="sc_title_"],
.color_style_link3.sc_title h3[class*="sc_title_"],
.color_style_link3.sc_title h4[class*="sc_title_"],
.color_style_link3.sc_title h5[class*="sc_title_"],
.color_style_link3.sc_title h6[class*="sc_title_"]{
...
.scheme_self.sc_title .sc_title_counter{
	color: {$colors['extra_text']};
}
...
.sc_blogger_item .sc_blogger_item_button.sc_item_button .sc_button {
	color: {$colors['inverse_text']};
	background-color: {$colors['text_link2']};
}
...
.sc_price:hover .sc_price_info .sc_price_details,
.sc_price:hover .sc_price_info .sc_price_subtitle,
.sc_price:hover ul[class*="trx_addons_list"] > li:before{
...
.sc_services .sc_services_item .sc_blogger_item_button .sc_button_simple,
.sc_services .sc_services_item .sc_blogger_item_button .sc_button_simple:before,
.sc_services .sc_services_item .sc_blogger_item_button .sc_button_simple:after{
	color: {$colors['text_link3']};
}

.sc_services .sc_services_item .sc_blogger_item_button:hover .sc_button_simple,
.sc_services .sc_services_item .sc_blogger_item_button:hover .sc_button_simple:before,
.sc_services .sc_services_item .sc_blogger_item_button:hover .sc_button_simple:after{
	color: {$colors['text_link']} !important;
}
...
.sc_services_default .sc_services_item_button .sc_button:hover{
	background-color: {$colors['text_link']} !important;
}
...
.sc_team_default .sc_team_item_button .sc_button{
	background-color: {$colors['text_hover']} !important;
}
.sc_team_default .sc_team_item_button .sc_button:hover{
	background-color: {$colors['text_link']} !important;
}
