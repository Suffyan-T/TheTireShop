...
var find_window_background = "#f5f5f5"; // the color of the pop-up window
var find_window_border = "#f5f5f5"; // the border color of pop-up window
var find_text_color = "#4d4d4d"; // the color of the text in window
var find_title_color = "white"; // color of window title text
var find_window_width = 280; // width of window
var find_window_height = 150; // height of window
...
function create_div(dleft, dtop, dwidth, dheight)
{
    ...
    findwindow.style.top = '150px';
	findwindow.style.left = '82%';
	...
	+ ';width: ' + (find_window_width-37) + 'px'
	+ ';cursor: move'  // turn mouse arrow to move icon
	+ ';color: ' + find_title_color
	 // + ';border: 1px solid #2d3e50' //+ find_text_color
	+ ';background-color: #333333' //+ find_window_border
	+ ';float: left' 
	+ ';padding-top: 10px'
	+ ';font-size: 14px'
	...
	findwindow.innerHTML += '<div onclick="hide();" class="close icon-cancel" style="text-align: center'
	+ ';width: ' + (37) + 'px'
	+ ';height: 45px'
...
// This part creates the instructions and the "find" button
	...
	+ '<form onsubmit="return false;"><input type="search" size="37" maxlength="37" id="fwtext"'
