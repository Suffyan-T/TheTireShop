...
if ( !function_exists('autoparts_customizer_theme_setup1') ) {
	...
	function autoparts_customizer_theme_setup1() {
		...
		autoparts_storage_set('scheme_color_groups', array(
			'main'	=> array(
							'title'			=> __('Main', 'autoparts'),
							'description'	=> __('Colors of the main content area', 'autoparts')
							),
			'alter'	=> array(
							'title'			=> __('Alter', 'autoparts'),
							'description'	=> __('Colors of the alternative blocks (sidebars, etc.)', 'autoparts')
							),
			'extra'	=> array(
							'title'			=> __('Extra', 'autoparts'),
							'description'	=> __('Colors of the extra blocks (dropdowns, price blocks, table headers, etc.)', 'autoparts')
							),
			'inverse' => array(
							'title'			=> __('Inverse', 'autoparts'),
							'description'	=> __('Colors of the inverse blocks - when link color used as background of the block (dropdowns, blockquotes, etc.)', 'autoparts')
							),
			'input'	=> array(
							'title'			=> __('Input', 'autoparts'),
							'description'	=> __('Colors of the form fields (text field, textarea, select, etc.)', 'autoparts')
							),
			)
		);
		autoparts_storage_set('scheme_color_names', array(
			'bg_color'	=> array(
							'title'			=> __('Background color', 'autoparts'),
							'description'	=> __('Background color of this block in the normal state', 'autoparts')
							),
			'bg_hover'	=> array(
							'title'			=> __('Background hover', 'autoparts'),
							'description'	=> __('Background color of this block in the hovered state', 'autoparts')
							),
			'bd_color'	=> array(
							'title'			=> __('Border color', 'autoparts'),
							'description'	=> __('Border color of this block in the normal state', 'autoparts')
							),
			'bd_hover'	=>  array(
							'title'			=> __('Border hover', 'autoparts'),
							'description'	=> __('Border color of this block in the hovered state', 'autoparts')
							),
			'text'		=> array(
							'title'			=> __('Text', 'autoparts'),
							'description'	=> __('Color of the plain text inside this block', 'autoparts')
							),
			'text_dark'	=> array(
							'title'			=> __('Text dark', 'autoparts'),
							'description'	=> __('Color of the dark text (bold, header, etc.) inside this block', 'autoparts')
							),
			'text_light'=> array(
							'title'			=> __('Text light', 'autoparts'),
							'description'	=> __('Color of the light text (post meta, etc.) inside this block', 'autoparts')
							),
			'text_link'	=> array(
							'title'			=> __('Link', 'autoparts'),
							'description'	=> __('Color of the links inside this block', 'autoparts')
							),
			'text_hover'=> array(
							'title'			=> __('Link hover', 'autoparts'),
							'description'	=> __('Color of the hovered state of links inside this block', 'autoparts')
							),
			'text_link2'=> array(
							'title'			=> __('Link 2', 'autoparts'),
							'description'	=> __('Color of the accented texts (areas) inside this block', 'autoparts')
							),
			'text_hover2'=> array(
							'title'			=> __('Link 2 hover', 'autoparts'),
							'description'	=> __('Color of the hovered state of accented texts (areas) inside this block', 'autoparts')
							),
			'text_link3'=> array(
							'title'			=> __('Link 3', 'autoparts'),
							'description'	=> __('Color of the other accented texts (buttons) inside this block', 'autoparts')
							),
			'text_hover3'=> array(
							'title'			=> __('Link 3 hover', 'autoparts'),
							'description'	=> __('Color of the hovered state of other accented texts (buttons) inside this block', 'autoparts')
							)
			)
		);
