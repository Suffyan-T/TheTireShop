						...
						?><div class="sc_layouts_title_title"><?php
							...
							<h1 class="sc_layouts_title_caption<?php echo esc_attr($autoparts_blog_title_class); ?>"><?php
								...
								if (!empty($autoparts_top_icon)) {
									...
									?><img src="<?php echo esc_url($autoparts_top_icon); ?>" alt="" <?php if (!empty($autoparts_attr[3])) autoparts_show_layout($autoparts_attr[3]);?>><?php
								}
								echo wp_kses_data($autoparts_blog_title_text);
							?></h1>
							<?php
