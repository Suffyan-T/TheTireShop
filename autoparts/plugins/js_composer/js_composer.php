...
if ( !function_exists( 'autoparts_vc_tgmpa_required_plugins' ) ) {
	//Handler of the add_filter('autoparts_filter_tgmpa_required_plugins',	'autoparts_vc_tgmpa_required_plugins');
	function autoparts_vc_tgmpa_required_plugins($list=array()) {
		if (in_array('js_composer', autoparts_storage_get('required_plugins'))) {
			...
			$list[] = array(
					'name' 		=> esc_html__('Visual Composer', 'autoparts'),
					'slug' 		=> 'js_composer',
...
if ( !function_exists( 'autoparts_vc_frontend_scripts' ) ) {
	//Handler of the add_action( 'wp_enqueue_scripts', 'autoparts_vc_frontend_scripts', 1100 );
	function autoparts_vc_frontend_scripts() {
		if (autoparts_exists_visual_composer()) {
			if (autoparts_is_on(autoparts_get_theme_option('debug_mode')) && autoparts_get_file_dir('plugins/js_composer/js_composer.css')!='')
				wp_enqueue_style( 'autoparts-js_composer',  autoparts_get_file_url('plugins/js_composer/js_composer.css'), array(), null );
		}
	}
}
...
if ( !function_exists( 'autoparts_vc_merge_styles' ) ) {
	//Handler of the add_filter('autoparts_filter_merge_styles', 'autoparts_vc_merge_styles');
...
if ( !function_exists( 'autoparts_vc_iconpicker_type_fontawesome' ) ) {
	//Handler of the add_filter( 'vc_iconpicker-type-fontawesome',	'autoparts_vc_iconpicker_type_fontawesome' );
...
if ( !function_exists( 'autoparts_vc_add_params_classes' ) ) {
	//Handler of the add_filter( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'autoparts_vc_add_params_classes', 10, 3 );
